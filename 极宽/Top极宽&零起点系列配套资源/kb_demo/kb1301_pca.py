...
#drx0 = PCA(n_components='mle',  svd_solver ='arpack',copy=True)
#drx8 = PCA(n_components=8, copy=True, whiten=False)
...
print('#4.4,检查数据处理结果')
#print('\npca#0',drx0.explained_variance_ratio_)
print('\npca',drx.explained_variance_ratio_)
#print('v',mx.explained_variance_)
#
