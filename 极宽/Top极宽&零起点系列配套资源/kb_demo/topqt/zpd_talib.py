...
def tax_mul(xfun,df,ksgn='close',vlst=[5,10,15,30]):
...
（1）D大于80 ，超买； D小于20，超卖；J大于100%，超买；J小于10%，超卖。
 ...
 （%）KDJ指标对于大盘和热门大盘股有极高准确性。
    ...
    #
    df['kdj_k']=MA01(df,m1,'rsv')
    df['kdj_d']=MA01(df,m2,'kdj_k')
