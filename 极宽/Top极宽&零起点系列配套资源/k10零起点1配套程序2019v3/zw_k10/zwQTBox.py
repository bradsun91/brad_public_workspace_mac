...
def xedit_zwXDat(df):
    ...
    df=ta.MA(df,5,'volume');df=ta.MA(df,10,'volume');
    df=ta.MA(df,20,'volume');df=ta.MA(df,30,'volume');
    df =df.rename(columns={'ma_5':'v-ma5','ma_10':'v-ma10','ma_20':'v-ma20','ma_30':'v-ma30'})
    ...
    df=ta.MA(df,5,'volume');
    df=ta.MA(df,10,'volume');
    df=ta.MA(df,20,'volume');
    df=ta.MA(df,30,'volume');
    ...
    clst=["open","high","low","close","volume","xdiff","z-open","z-high","z-low","z-close","z-xdiff","ma_5","ma_10","ma_20","ma_30","v-ma5","v-ma10","v-ma20","v-ma30"]
