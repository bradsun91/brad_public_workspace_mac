...
def VWAP_dataPre(qx,xnam0,ksgn0):
    ...
    for xcod in zw.stkLibCode:
        ...
        d20['vw_sum']=(d20['dprice']*d20['volume']).rolling(center=False,window=nwin).sum()
        d20['vw_vol']=d20['volume'].rolling(center=False,window=nwin).sum()
...
def tur10_dataPre(qx,xnam0,ksgn0):
    ...
    for xcod in zw.stkLibCode:
        ...
        d20[ksgn]=d20['low'].rolling(window=d,center=False).min()
