...
timeliness_metrics = [
       'entity_author_timeliness_score', 'entity_source_timeliness_score',
       'event_author_timeliness_score','event_source_timeliness_score',
       'overall_author_timeliness_score','overall_source_timeliness_score']

credibility_metrics = [
       'entity_author_republish_score', 'entity_source_republish_score',
       'event_author_republish_score','event_source_republish_score',
       'overall_author_republish_score','overall_source_republish_score'
       ]
...
stry_grp_sentiment_stdev_metric = [
